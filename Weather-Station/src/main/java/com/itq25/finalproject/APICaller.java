...
public class APICaller {
    ...
    public void getWeatherData(float latitude, float longitude, String unitType ) throws IOException, InterruptedException {
        ...
        String URLEndPoint_1day = "&current=temperature_2m,weather_code,wind_speed_10m,wind_direction_10m&hourly=temperature_2m,weather_code,wind_speed_10m&forecast_days=1"; //&"+tempUnit+"&"+windUnit;
        String URLEndPoint_3days = "&hourly=temperature_2m,wind_speed_10m&forecast_days=3";
        ...
        if (unitType.equals("Imperial")) {
            completeURL_1day = completeURL_1day + "&temperature_unit=fahrenheit&wind_speed_unit=mph";
            completeURL_3days = basicURL + URLEndPoint_3days + "&temperature_unit=fahrenheit&wind_speed_unit=mph";
        } 
